<template>
    <div class="flex flex-col items-center justify-center h-full w-full px-auto md:px-[10%]">
        <!-- Title -->
        ...
        <!-- component -->
        <div v-if="responseData" class="flex justify-center items-center min-h-screen">
            <div v-if="responseData.success" class="md:max-w-[720px] mx-auto">
                <!-- Centering wrapper -->
            ...
            <div v-else class="mt-6 text-center text-gray-600">
                ...
                <p><a href="https://nekosia.cat/documentation?page=api-endpoints#tags-and-categories" class="text-blue-500 underline">Check available tags and categories</a></p>
            </div>
        </div>
    </div>
</template>
